...
<body style="margin: 50px">
    ...
    if (isset($_GET["sender_id"])) {
        ...
        $sql = "SELECT * FROM customers_info WHERE id='$sender_id'";
    ...
    if (isset($_POST["submit"])) {
        ...
        $sql = "SELECT * FROM customers_info WHERE id='$receiver_id'";
        $result = $connection->query($sql);
        ...
        if ($sender_balance < $amount) {
            ...
            $sql = "UPDATE customers_info SET balance='$new_sender_balance' WHERE id='$sender_id'";
            ...
            $sql = "UPDATE customers_info SET balance='$new_receiver_balance' WHERE id='$receiver_id'";
    ...
    <div class="container">
        ...
        <div class="image">
            <img src="image.svg" alt="money-transfer">
        </div>
        <form method="POST">
            <div class="form-group">
                ...
                <input style="padding:10px" type="text" class="form-control" id="sender-name" name="sender_name"
                    value="<?php echo $sender["customer_name"]; ?>" readonly>
            </div>
            <div class="form-group">
    ...
    <div class="nav"> <a class="back" href="customer.php">Back to All Customers</a> </div>
</body>
